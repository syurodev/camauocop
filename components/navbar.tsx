                ...
                <>
                  ...
                  {/* Thêm hàng */}
                  {
                    session?.user?.role !== "individual" && (
                      <Button variant={"ghost"} onClick={() => router.push("/products/product/add")} className='p-2'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  <Popover>
                    <PopoverTrigger>
                      <Image className='object-cover rounded-full' src={session?.user.image || "/images/avatarDefault.png"} alt='avatar' height={40} width={40} priority />
                    </PopoverTrigger>
                    <PopoverContent>
                      <div>
                ...
                <Popover>
                  ...
                  <PopoverContent>
                    <div className='flex flex-col gap-3 px-4'>
                      <Button variant={"ghost"} className='w-full mt-3 p-2 !justify-start' >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                        </svg>
                        <span className='ml-2'>

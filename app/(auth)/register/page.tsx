...
import { UserRegisterZodSchema, IUserRegisterZodSchema } from '@/lib/zodSchema/auth';
...
export default function Register() {
  ...
  return (
    <motion.section
      className='glassmorphism transition-all duration-150 max-sm:w-full md:max-w-xl w-[500px] px-4 sm:px-6 md:px-8'
    ...
    >
      ...
      >
        <p className='mt-3 font-normal text-sm'>Đã có tài khoản? <Link className='font-semibold' href={"/login"}>Đăng nhập</Link></p>
      </motion.div >
    </motion.section >
  );
}

...
import { UserLoginZodSchema, type IUserLoginZodSchema } from '@/lib/zodSchema/auth';
...
export default function SigninPage() {
  ...
  return (
    ...
    >
      ...
      >
        <p className='mt-3 font-normal text-sm'>Chưa có tài khoản? <Link className='font-semibold' href={"/register"}>Đăng ký</Link></p>
      </motion.div >
